<template>
  <div>
    ...
    <h1>Search for a song to reverse-nuke (ie. add to all playlists)</h1>
    ...
    <div v-for="track in allTracks" :key="track.id">
        <TrackPreview class="playlist" :title="track.name" :artists="track.artists" :image="track.album.images[0].url" :id="track.id" :reversenuke="true"/>
    </div>
